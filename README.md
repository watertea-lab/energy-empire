...
- 👤 作者/組員:【江畤銘 林佑宣】
- 🏫 課程 / 指導老師 / 學校:【JavaScript網頁設計 / 張淑雅老師 / 淡江大學】
...
**目標**:以起始資金 **NT$10,000,000** 操作,透過「能源投資」與「股票交易」讓**總資產淨值**盡量成長。隨時可按「📊 結算」查看總報酬率與評等。

**畫面配置**
- **上方 HUD**:回合數、現金、總資產淨值與報酬率(隨時掌握整體賺賠)。
- **能源市場**:能源結構占比,以及再生占比、綠能加成、累計投入、回本回合。
- **股票市場**:8 支個股的原幣價與台幣價。
- **我的持倉**:已買進的股票、成本與損益。
- **即時數據**:油價、天氣、太陽輻射、空氣品質等真實資料。

**兩種獲利方式**
1. **能源投資(被動收入)**:投資 ☀️太陽 / 🛢️石油 / ⚛️核能 / 💨風能 來調整能源結構(每次 NT$30 萬)。**再生能源(太陽+風)占比越高,每回合被動收入越高**;投資化石或核能會稀釋再生占比、使收入下降。可參考面板的「回本回合」判斷是否划算。
2. **股票交易(資本利得)**:用「📈 買股票」以台幣買進、在持倉用「📉 賣股票」賣出。股價為真實市場數據,買低賣高賺價差。

**一回合的流程**
1. 回合內自由進行能源投資與股票買賣。
2. 按「⏭️ 下一回合」:回合 +1、依再生占比發放被動收入、股價波動,並有機率觸發影響能源結構的隨機事件。

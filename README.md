...
- **背景音樂(AI 生成)**:`bgm.mp3`、`bgm2.mp3` 為透過 **Suno** 付費方案生成之 AI 背景音樂,並已**付費取得授權**,以避免版權爭議。
- 背景音樂之版權屬**作者持有**,於本專案僅供**個人、非營利之合理使用**。
- 其餘第三方元件(Tailwind CSS、Lucide Icons 等)依其各自之開源授權條款使用。
